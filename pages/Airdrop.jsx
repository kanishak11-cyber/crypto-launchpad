  ...
  return (
    <div className={style.wrapper}>
      <div className={style.titleContainer}>
        <Link href='/' ><h1 className={style.title}>Home </h1></Link> <span> / Airdrop</span>
      </div>
      <div className={style.container}>
        <h1 className={style.comingSoon}>Airdrop <span className={style.spanColor}>Coming Soon</span></h1>
      </div>
  </div>
  )
}
